...
## Music
- AT LEAST 1 song for general exploration (should be long & varied)
- Boss song (VERY LONG & VERY VARIED - use multiple versions for immersive soundtrack)
## SFX
- Ambient SFX for rooms
...
- Main menu - with specific song
- Second biome - e.g. tileset, soundtrack, etc. after getting ability 2
